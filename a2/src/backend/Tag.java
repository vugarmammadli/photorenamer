...
public class Tag implements Serializable {
	 ...
	 * 
	 * @param name String to replace name of tag
	 */
	 ...
	 * 
	 * @param numUsed new value of numUsed
	 */
	 ...
	 * 
	 * @param allTags new list of tags to replace allTags
	 */
	 ...
	 * 
	 * @param other  Tag object to compare to
